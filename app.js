...
class uptimeDealerAPI {
    ...
    async deleteMonitor({ monitorID, url }) { // monitorID or url
        try {
            let res = await axios.post(this.api,
                {
                    key: this.key,
    ...
    async getMonitor({ monitorID, url }) { // monitorID or url
        try {
            let res = await axios.post(this.api,
                {
                    key: this.key,
    ...
    async updateMonitor({ monitorID, url, name, description }) { // monitorID or url
        try {
            let res = await axios.post(this.api,
                {
                    key: this.key,
    ...
    async changeMonitorStatus({ monitorID, url, status, statusType }) { // monitorID or url
        try {
            let res = await axios.post(this.api,
                {
                    key: this.key,
